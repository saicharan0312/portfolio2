        ...
        <div>
          <form className='contact-me'>
            <label className='label-name-email'>
              Name:
              <input className='input-name-email' type="text" value={name} onChange={(event) => setName(event.target.value)}/>
            </label>
            
            <label className='label-name-email'>
              Email:
              <input className='input-name-email' type="text" value={email} onChange={(event)=> setEmail(event.target.value)}/>
            </label>
            
            <label className='label-essay'>
              Essay:
              <textarea className='input-essay' type="text" value={essay} onChange={(event)=> setEssay(event.target.value)}/>
            </label>
